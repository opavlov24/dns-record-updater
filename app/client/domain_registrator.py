...
class GoDaddyDomainRegistratorClient(DomainRegistratorClient):
    ...
    def get_record(self, domain_name: str, record_type: str, name: str) -> Record:
        url = self.url + "{domain_name}/records/{record_type}/{name}".format(domain_name=domain_name,
    ...
    def update_record(self, record: Record):
        url = self.url + "{domain_name}/records/{record_type}/{name}".format(domain_name=record.domain_name,
