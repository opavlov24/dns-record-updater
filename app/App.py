...
class DnsUpdater:
    def __init__(self, ip_client: IpClient, domain_registrator_client: DomainRegistratorClient, properties: UpdaterProperties):
    ...
    def update(self):
        ...
        record: Record = self.domain_registrator_client.get_record(self.properties.domain_name, self.properties.record_type, self.properties.record_name)
